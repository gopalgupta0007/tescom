...
const Home = () => {
    ...
    return (
        <div id="homeContainer" style={{ position: 'relative', top: '100px', marginBottom:'300px' }}>
            ...
            <section style={{ width: '95%', height: '80vh', display: 'flex', flexDirection:document.body.offsetWidth>1000?'row':'column-reverse', margin: '0 auto -50px', justifyContent: 'space-between', alignItems: 'center', borderBottom: '3px solid #ddd' }}>
                <div id='tescomDetails slideDownText' style={{ width: '30%', display: 'flex',flexDirection: 'column', justifyContent: 'center', marginLeft: '3%', position: 'relative', bottom: '20px', zIndex: 50 }}>
                    ...
                    <h2 id='business_solutinos'><b className='textTypeAnimation_business' data-text="BUSINESS">BUSINESS</b>&nbsp;<b className='textTypeAnimation_solutions' data-text="SOLUTIONS">SOLUTIONS</b></h2>
                ...
                <div id='tescomImgs'><img src={animatedImg} style={{ width: '50vw', transform: 'scale(1.3)', position: 'relative', right: '100px' }} alt="animation" /></div>
            </section>
            <section id='carousel' >
                <center><h1 style={{ color: 'black', position: 'relative', top: '100px', fontWeight: 'bolder', fontSize: '2.4vw', margin: '-1vw 2.5% 0' }}>Tescom: Bringing You the Latest in Telecommunications Innovation - Photo Gallery</h1></center>

...
const Header = () => {
    ...
    return (
        <nav class="navbar navbar-expand-lg bg-body-tertiary" style={{ width: '100%', borderRadius: '0 0 .5vw .5vw', boxShadow: '0 3px 0 #aaa', position: 'fixed', zIndex: '100' }}>
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav" style={{ padding: '5px 0 0' }}>
                    <ul class="navbar-nav" style={{ fontSize: document.body.offsetWidth >= 768 ? '1.5vw' : '2vw' }} >
                        <li class="nav-item" onClick={() => navigate('/')}>
                            <a class="nav-link active" aria-current="page" style={{ fontSize: document.body.offsetWidth >= 768 ? '1.5vw' : '2vw' }}>Home</a>
                        </li>
                        <li class="nav-item" onClick={() => navigate('/about')} id='about' >
                            <a class="nav-link" style={{ fontSize: document.body.offsetWidth >= 768 ? '1.5vw' : '2vw' }}>About</a>
                        </li>
                        <li class="nav-item" id='service' onMouseOver={() => slideDownAnimation("service")} onMouseLeave={() => slideUpAnimation("service")}>
                            <a class="nav-link" style={{ fontSize: document.body.offsetWidth >= 768 ? '1.5vw' : '2vw' }}>Services&nbsp;<i class="fa-solid fa-angle-down" style={{ fontSize: document.body.offsetWidth >= 768 ? '1.5vw' : '2vw', alignItems: 'center' }}></i></a>
                        ...
                        <li class="nav-item" onClick={() => navigate('/contactus')}>
                            <a class="nav-link" style={{ fontSize: document.body.offsetWidth >= 768 ? '1.5vw' : '2vw' }}>Contact Us</a>
                        </li>
                        <li class="nav-item" onClick={() => navigate('/career')}>
                            <a class="nav-link" style={{ fontSize: document.body.offsetWidth >= 768 ? '1.5vw' : '2vw' }}>Career</a>
                        </li>
                    </ul>
                </div>
            </div>
